...
training_set = dataset.iloc[:780, 1:2].values
test_set  = dataset.iloc[780:, 1:2].values
...
plt.plot(real_stock_price, color = 'red', label = 'Real Alibaba Stock Price')
plt.plot(predicted_stock_price, color = 'blue', label = 'Predicted Alibaba Stock Price')
plt.title('Alibaba Stock Price Prediction')
plt.xlabel('Time')
plt.ylabel('Alibaba Stock Price')
plt.legend()
plt.show()
